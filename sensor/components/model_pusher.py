...
class ModelPusher:
    ...
    def initiate_model_pusher(self,)->ModelPusherArtifact:
        try:
            ...
            save_object(file_path=self.model_pusher_config.pusher_trarget_encoder_path,obj=target_encoder)
            ...
            model_pusher_artifact = ModelPusherArtifact(pusher_model_dir=self.model_pusher_config.puhser_model_dir,
